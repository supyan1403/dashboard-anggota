    ...
    <form action="{{ route('kegiatan.peserta.sync', $kegiatan->id) }}" method="POST">
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="flex gap-4">
                <a href="{{ route('kegiatan.index') }}" class="px-6 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300">Kembali</a>
                <button type="submit" class="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">Simpan Perubahan Peserta</button>
            </div>
        </div>
