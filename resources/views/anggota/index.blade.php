        ...
        <div class="flex flex-col md:flex-row justify-between items-center mb-4 gap-4">
            ...
            <form action="{{ route('anggota.index') }}" method="GET" class="flex flex-wrap items-center gap-3">
                ...
                <div class="flex items-center gap-2">
                    <button type="submit"
                        class="px-4 py-2 bg-blue-600 text-white text-sm rounded-lg hover:bg-blue-700">Filter</button>
                    <a href="{{ route('anggota.index') }}"
                        class="px-4 py-2 bg-gray-300 text-gray-700 text-sm rounded-lg hover:bg-gray-400">Reset</a>
                </div>
            </form>
